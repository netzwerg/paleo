...
public class DataFrameTest {
    ...
    public void defaultColumnTypes() {
        ...
        assertEquals(AGE, df.getColumnId(1, ColumnType.PRIMITIVE_INT));
        ...
        assertEquals(HEIGHT, df.getColumnId(2, ColumnType.PRIMITIVE_DOUBLE));
        ...
        assertEquals(DATE_OF_BIRTH, df.getColumnId(3, ColumnType.TIMESTAMP));
        ...
        assertEquals(GENDER, df.getColumnId(4, ColumnType.CATEGORY));
