# Paleo
image:https://travis-ci.org/netzwerg/paleo.svg?branch=master["Build Status", link="https://travis-ci.org/netzwerg/paleo"] image::https://api.bintray.com/packages/netzwerg/maven/paleo/images/download.svg[link="https://bintray.com/netzwerg/maven/paleo/_latestVersion"]
...
Paleo makes extensive use of the https://github.com/javaslang/javaslang library[Javaslang]. Javaslang provides
